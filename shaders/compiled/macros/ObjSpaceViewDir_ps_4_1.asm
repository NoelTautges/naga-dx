...
dcl_output o0.xyz
dcl_temps 1
mul r0.xyz, cb0[4].yyyy, cb0[114].xyzx
mad r0.xyz, cb0[113].xyzx, cb0[4].xxxx, r0.xyzx
mad r0.xyz, cb0[115].xyzx, cb0[4].zzzz, r0.xyzx
add r0.xyz, r0.xyzx, cb0[116].xyzx
add o0.xyz, r0.xyzx, -v0.xyzx
ret 
