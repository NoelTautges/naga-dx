...
dcl_output o0.xyz
dcl_temps 1
mul r0.xyz, v0.yyyy, cb0[110].xyzx
mad r0.xyz, cb0[109].xyzx, v0.xxxx, r0.xyzx
mad r0.xyz, cb0[111].xyzx, v0.zzzz, r0.xyzx
mad r0.xyz, cb0[112].xyzx, v0.wwww, r0.xyzx
mad o0.xyz, -r0.xyzx, cb0[31].wwww, cb0[31].xyzx
ret 
