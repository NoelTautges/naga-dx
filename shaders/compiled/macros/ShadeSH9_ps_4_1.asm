...
//   float4 unity_SHAr;                 // Offset: 1120 Size:    16
//   float4 unity_SHAg;                 // Offset: 1136 Size:    16
//   float4 unity_SHAb;                 // Offset: 1152 Size:    16
//   float4 unity_SHBr;                 // Offset: 1168 Size:    16
//   float4 unity_SHBg;                 // Offset: 1184 Size:    16
//   float4 unity_SHBb;                 // Offset: 1200 Size:    16
//   float4 unity_SHC;                  // Offset: 1216 Size:    16
...
dcl_temps 3
mul r0.x, v0.y, v0.y
mad r0.x, v0.x, v0.x, -r0.x
mul r1.xyzw, v0.yzzx, v0.xyzz
dp4 r2.x, cb0[73].xyzw, r1.xyzw
dp4 r2.y, cb0[74].xyzw, r1.xyzw
dp4 r2.z, cb0[75].xyzw, r1.xyzw
mad r0.xyz, cb0[76].xyzx, r0.xxxx, r2.xyzx
dp4 r1.x, cb0[70].xyzw, v0.xyzw
dp4 r1.y, cb0[71].xyzw, v0.xyzw
dp4 r1.z, cb0[72].xyzw, v0.xyzw
