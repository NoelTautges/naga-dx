...
dcl_output o0.xyz
dcl_temps 1
mul r0.xyz, cb0[31].yyyy, cb0[114].xyzx
mad r0.xyz, cb0[113].xyzx, cb0[31].xxxx, r0.xyzx
mad r0.xyz, cb0[115].xyzx, cb0[31].zzzz, r0.xyzx
mad r0.xyz, cb0[116].xyzx, cb0[31].wwww, r0.xyzx
mad o0.xyz, -v0.xyzx, cb0[31].wwww, r0.xyzx
ret 
