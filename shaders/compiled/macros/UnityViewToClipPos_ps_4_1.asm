...
//   float4x4 glstate_matrix_projection;// Offset: 2048 Size:    64
...
dcl_output o0.xyzw
dcl_temps 1
mul r0.xyzw, v0.yyyy, cb0[129].xyzw
mad r0.xyzw, cb0[128].xyzw, v0.xxxx, r0.xyzw
mad r0.xyzw, cb0[130].xyzw, v0.zzzz, r0.xyzw
add o0.xyzw, r0.xyzw, cb0[131].xyzw
ret 
